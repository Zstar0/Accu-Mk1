...
This project is indexed by GitNexus as **Accu-Mk1** (7485 symbols, 13258 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
