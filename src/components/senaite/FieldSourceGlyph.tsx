 ...
 *  visual change in SENAITE mode. Works standalone: ui/tooltip's Tooltip
 *  self-wraps in its own TooltipProvider, so no outer provider is needed
 *  (rich sectioned tooltip per docs/developer/ui-patterns.md). */
