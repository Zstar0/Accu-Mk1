...
describe('BoxLabelTemplate', () => {
  it('encodes the bare box id in the QR — the scanner-station contract', () => {
    render(
      <BoxLabelTemplate boxId={137} labelCode="BOX-3267-1" role="hplc" vialCount={4} createdAt={null} />,
    )
  ...
  it('meta row shows the short role and vial count — ster prints as PCR', () => {
    render(
      <BoxLabelTemplate boxId={137} labelCode="BOX-3267-1" role="ster" vialCount={2} createdAt={null} />,
    )
  ...
  it('xtra prints as XTRA on the meta row', () => {
    render(
      <BoxLabelTemplate boxId={137} labelCode="BOX-3267-1" role="xtra" vialCount={1} createdAt={null} />,
    )
  ...
  it('singularizes a one-vial count', () => {
    render(
      <BoxLabelTemplate boxId={137} labelCode="BOX-3267-1" role="endo" vialCount={1} createdAt={null} />,
    )
